...
See `documentation <https://thenewflesh.github.io/hidebound/>`_ for details.
...
.. image:: resources/screenshots/data_flow.png
   :target: resources/screenshots/data_flow.png
   :alt: 
...
.. image:: resources/screenshots/update.png
   :target: resources/screenshots/update.png
   :alt: 
...
.. image:: resources/screenshots/graph.png
   :target: resources/screenshots/graph.png
   :alt: 
...
.. image:: resources/screenshots/girder.png
   :target: resources/screenshots/girder.png
   :alt: 
...
.. image:: resources/screenshots/data.png
   :target: resources/screenshots/data.png
   :alt: 
...
.. image:: resources/screenshots/pre_update.png
   :target: resources/screenshots/pre_update.png
   :alt: 
...
.. image:: resources/screenshots/config.png
   :target: resources/screenshots/config.png
   :alt: 
...
.. image:: resources/screenshots/api.png
   :target: resources/screenshots/api.png
   :alt: 
...
.. image:: resources/screenshots/docs.png
   :target: resources/screenshots/docs.png
   :alt: 
...
.. image:: resources/screenshots/error.png
   :target: resources/screenshots/error.png
   :alt: 
...
.. list-table::
   ...
   * - docker-build
     - Build image of hidebound
   * - docker-build-prod
     - Build production image of hidebound
   * - docker-container
     - Display the Docker container id of hidebound
   * - docker-coverage
     - Generate coverage report for hidebound
   * - docker-destroy
     - Shutdown hidebound container and destroy its image
   * - docker-destroy-prod
     - Shutdown hidebound production container and destroy its image
   * - docker-image
     - Display the Docker image id of hidebound
   * - docker-prod
     - Start hidebound production container
   * - docker-push
     - Push hidebound production image to Dockerhub
   * - docker-remove
     - Remove hidebound Docker image
   * - docker-restart
     - Restart hidebound container
   * - docker-start
     - Start hidebound container
   * - docker-stop
     - Stop hidebound container
   * - docs
   ...
   * - zsh
     - Run ZSH session inside hidebound container
   * - zsh-complete
     - Generate oh-my-zsh completions
   * - zsh-root
     - Run ZSH session as root inside hidebound container
